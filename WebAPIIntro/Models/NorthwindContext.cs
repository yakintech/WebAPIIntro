...
public partial class NorthwindContext : DbContext
{
    ...
    public virtual DbSet<N11category> N11categories { get; set; }
    ...
    public virtual DbSet<VwNancySalesRepot> VwNancySalesRepots { get; set; }

    public virtual DbSet<VwProductDetail> VwProductDetails { get; set; }

    public virtual DbSet<VwReportsSales1997> VwReportsSales1997s { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<N11category>(entity =>
        {
            entity.ToTable("N11Category");
        ...
        modelBuilder.Entity<ProductStockLog>(entity =>
        {
            ...
            entity.HasOne(d => d.Product).WithMany(p => p.ProductStockLogs)
                .HasForeignKey(d => d.ProductId)
                .HasConstraintName("FK_ProductStockLog_Products");
        });
        ...
        modelBuilder.Entity<VwNancySalesRepot>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("vw_nancy_sales_repots");
        ...
        modelBuilder.Entity<VwReportsSales1997>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("vw_reports_sales_1997");
